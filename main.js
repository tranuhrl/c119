...
document.getElementById("span_toDraw").innerHTML = sketch;
...
if(drawn_sketch = sketch){
    answer_holder = "set";
    score = score + 1;
    document.getElementById("span_score").innerHTML = score;
}
...
function gotResult(error, results)
{
    ...
    document.getElementById("span_sketch").innerHTML = drawn_sketch;
    document.getElementById("span_confidence").innerHTML = results[0].confidence*1000 + "%";
}
